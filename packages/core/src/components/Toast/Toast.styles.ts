...
export const toast = tv({
  slots: {
    ...
    viewport: [
      'fixed bottom-[calc(max(1rem,var(--safe-area-inset-bottom,env(safe-area-inset-bottom,0px)))+4.125rem)] left-1/2 z-toast flex max-h-screen w-full -translate-x-1/2 flex-col-reverse items-center xl:bottom-14',
    ],
  },
  variants: {
    variant: {
