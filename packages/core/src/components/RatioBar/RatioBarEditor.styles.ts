...
export interface RatioBarEditorRootStyleOptions {
  disabled?: boolean;
}

export function ratioBarEditorRootStyles({
  disabled,
}: RatioBarEditorRootStyleOptions = {}) {
  return mergeStyles(
...
// 입력 필드들 컨테이너
export function ratioBarEditorFieldsStyles() {
...
export function ratioBarEditorInputStyles() {
  return inputBaseStyles;
}

// 입력 필드 내 텍스트
export function ratioBarEditorTextInputStyles() {
  return mergeStyles(
...
// 삭제 버튼 (X 아이콘)
export function ratioBarEditorRemoveButtonStyles() {
  return mergeStyles(
...
export function ratioBarEditorAddButtonStyles() {
  return addButtonBaseStyles;
}

// 추가 버튼 텍스트
export function ratioBarEditorAddButtonTextStyles() {
  return 'typo-fixed-16 text-gray-400';
}

// 푸터 (체크박스 + 삭제 버튼)
export function ratioBarEditorFooterStyles() {
  return 'flex items-center justify-between';
}

// 삭제 텍스트 버튼
export function ratioBarEditorDeleteButtonStyles() {
  return mergeStyles(
