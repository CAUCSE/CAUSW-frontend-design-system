...
- 외부 버튼이나 로직에 의해 시트를 닫아야 할 때 유용합니다.
        `}}},render:t=>{const[r,n]=u.useState(!1);return e.jsxs("div",{className:"flex flex-col items-center gap-4",children:[e.jsx("button",{onClick:()=>n(!0),className:"cursor-pointer rounded-sm bg-blue-500 px-4 py-2 text-sm text-white transition-colors hover:bg-blue-600 hover:text-gray-200",children:"Open"}),e.jsxs("div",{className:"text-sm text-gray-500",children:["현재 상태: ",r?"열림 (Open)":"닫힘 (Closed)"]}),e.jsx(o,{...t,open:r,onOpenChange:n,children:e.jsxs(o.Content,{children:[e.jsx(o.Header,{title:"제어형 모드"}),e.jsx(o.Body,{children:e.jsx("p",{className:"text-gray-600",children:"onOpenChange 이벤트를 통해 상태를 업데이트합니다."})}),e.jsx(o.Footer,{children:e.jsx(k,{onClick:()=>n(!1),color:"dark",fullWidth:!0,children:"닫기 (상태 변경)"})})]})})]})}},c={parameters:{docs:{description:{story:`
...
}`,...(T=(O=c.parameters)==null?void 0:O.docs)==null?void 0:T.source}}};const we=["Default","Controlled","LongContent"];export{i as Controlled,d as Default,c as LongContent,we as __namedExportsOrder,Ne as default};
